 ...
 */
class OffsitePaymentGatewayTest extends TestCase
{
    /**
     * @var OffsitePaymentGateway
     */
    protected $gateway;
    ...
    /**
     * Just verify that tests are running
     */
    public function testClassExists()
    {
        $this->assertTrue(class_exists(OffsitePaymentGateway::class));
    }
